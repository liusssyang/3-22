...
public class GroupAdapter extends RecyclerView.Adapter<GroupAdapter.ViewHolder>{
    ...
    public GroupAdapter(List<personMsg> msgList){
    ...
    public  ViewHolder onCreateViewHolder(ViewGroup parent,int viewType){
        ...
        holder.v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MyApplication.getContext(), CreateGroupTextMsgActivity.class);
    ...
    public void onBindViewHolder(ViewHolder holder,int position){
        ...
        holder.leftMsg.setText(msg.getGroupName());
        holder.simpleMessage.setText(msg.getGroupDescription());
        holder.time.setText(msg.getGroupType());
